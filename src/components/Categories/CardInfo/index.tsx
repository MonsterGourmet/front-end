     ...
     return (
          <S.Cardinfo>
               ...
               <S.BoxInfo className={Opens.className}>
                    ...
                    { Product.size && <S.Text className="description"><span> Peso - {Product.size}.</span></S.Text>  }
                    ...
                    { Product.peso && <S.Text className="description"><span> Tamanho - {Product.peso}.</span></S.Text>  }  
